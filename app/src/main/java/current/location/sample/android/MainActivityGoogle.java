 ...
 */
public class MainActivityGoogle extends AppCompatActivity {

    private static final String TAG = MainActivityGoogle.class.getSimpleName();
    ...
    private void startLocationTrackerService() {
        ...
        final long INTERVAL_LOCATION_UPDATES = 10000;
        locationRequest.setInterval(INTERVAL_LOCATION_UPDATES);
        final long FASTEST_INTERVAL_LOCATION_UPDATES = 5000;
        ...
        if (locationPermission == PackageManager.PERMISSION_GRANTED) {
            fusedLocationProviderClient.requestLocationUpdates(locationRequest, new LocationCallback() {
                ...
                public void onLocationResult(LocationResult locationResult) {
                    ...
                    if (location != null) {
                        Log.e(TAG, "onLocationResult() lat: " + location.getLatitude() + " lng:" + +location.getLongitude());
    ...
    private void startLocationPermissionRequest() {
        ActivityCompat.requestPermissions(MainActivityGoogle.this,
